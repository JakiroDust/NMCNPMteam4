...
INSERT INTO dbo.LOAIPHONG (MaLoaiPhong, TenLoaiPhong, DonGia) VALUES ('M03', 'Phòng 3', 180000)

INSERT INTO dbo.PHONG (MaPhong, MaLoaiPhong, GhiChu, TinhTrang) VALUES ('P12', 'M03', null, 1)

INSERT INTO dbo.PHIEUTHUEPHONG (MaPhong, SoLuongKhach, NgayBDThue, DonGiaSan) VALUES ('P06', 2, GETDATE(), 150000)

select * from PHIEUTHUEPHONG where MaPhong = 'P01'

INSERT INTO dbo.LOAIKHACH (MaLoaiKhach, LoaiKhach, HeSo) VALUES ('NN', 'Nước ngoài', 1.5)

INSERT INTO dbo.CT_PHIEUTHUEPHONG(MaPhieuThuePhong, TenKH, MaLoaiKhach, CMND, DiaChi) VALUES ('3', 'Thang 7', 'ND', '77777','HA NOI')

UPDATE dbo.PHONG SET TinhTrang = 0 WHERE MaPhong = 'P06'
