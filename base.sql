...
(
	MaBaoCaoDoanhThu INT IDENTITY PRIMARY KEY,
	Thang SMALLINT,
	Nam SMALLINT,
...
(
	MaCT_BaoCaoDoanhThu INT IDENTITY PRIMARY KEY,
...
ALTER TABLE dbo.CT_BAOCAODOANHTHU ADD CONSTRAINT FK_CT_BAOCAODOANHTHU_LOAIPHONG FOREIGN KEY(MaLoaiPhong) REFERENCES dbo.LOAIPHONG(MaLoaiPhong)
ALTER TABLE dbo.CT_BAOCAODOANHTHU ADD CONSTRAINT FK_CT_BAOCAODOANHTHU_BAOCAODOANHTHU FOREIGN KEY(MaBaoCaoDoanhThu) REFERENCES dbo.BAOCAODOANHTHU(MaBaoCaoDoanhThu)
