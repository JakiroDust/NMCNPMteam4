...
namespace QuanLyKhachSan.DAO
{
    public class LoaiPhongDAO
    {
        ...
        public void ResetLoaiPhong()
        {
            DataProvider.Instance.ExecuteNonQuery("delete from LOAIPHONG; insert into LOAIPHONG(TenLoaiPhong, DonGia) VALUES('A', 150000); insert into LOAIPHONG(TenLoaiPhong, DonGia) VALUES('B', 170000); insert into LOAIPHONG(TenLoaiPhong, DonGia) VALUES('C', 200000);");
        }
